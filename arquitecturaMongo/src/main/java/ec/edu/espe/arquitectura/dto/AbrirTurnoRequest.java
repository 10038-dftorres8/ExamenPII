...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Solicitud para abrir un turno de caja")
public class AbrirTurnoRequest {
    ...
    @Schema(description = "Monto inicial recibido de la bóveda", example = "5000.00", required = true)
    private BigDecimal montoInicial;
    
    @Schema(description = "Lista de denominaciones recibidas", required = true)
    ...
    public static class DenominacionDto {
        ...
        @Schema(description = "Cantidad de billetes", example = "30", required = true)
        private Integer cantidadBilletes;
        
        @Schema(description = "Monto total de esta denominación", example = "3000.00", required = true)
